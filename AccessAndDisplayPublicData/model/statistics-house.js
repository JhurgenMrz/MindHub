...
//table
if(document.getElementById('least-engaged-house')){
    const tableLeastEngagedSenate = document.getElementById('least-engaged-house')
    ...
    //Render Table Most Engaged
    //table
    const tableMostEngagedSenate = document.getElementById('most-engaged-house')
...
if(document.getElementById('least-loyal-house') && document.getElementById('most-loyal-house')){
    
    //Table Least Loyal House
    const tableLeastLoyalSenate =  document.getElementById('least-loyal-house')
    ...
    //Table Most Loyal House
    const tableMostLoyalSenate = document.getElementById('most-loyal-house')
