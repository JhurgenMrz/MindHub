...
FetchData('house').then(data => {
    ...
    house_stttcs.party[0].votes_with_party = averageTotalVotes(house_stttcs.party[0].members, house_stttcs.party[0].number)
    house_stttcs.party[1].votes_with_party = averageTotalVotes(house_stttcs.party[1].members, house_stttcs.party[1].number)
    house_stttcs.party[2].votes_with_party = averageTotalVotes(house_stttcs.party[2].members, house_stttcs.party[2].number)
    house_stttcs.avg_votes_with_party = round(((house_stttcs.party[0].votes_with_party+house_stttcs.party[1].votes_with_party) / (house_stttcs.party.length-1)),2)
